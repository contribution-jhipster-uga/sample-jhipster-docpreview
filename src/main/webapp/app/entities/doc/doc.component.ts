...
export class DocComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.docService
      ...
      .subscribe(
        (res: HttpResponse<IDoc[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInDocs(): void {
    this.eventSubscriber = this.eventManager.subscribe('docListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDoc[] | null, headers: HttpHeaders, page: number): void {
